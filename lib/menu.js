exports.menu = (id, Fanhcore__Bot, corohelp, tampilTanggal, tampilWaktu, fanhcore__2542, http://api.whatsapp.com/send?phone=6282132209625, Ketika diaktifkan oleh Owner, https://chat.whatsapp.com/GnLdLnx9zx69Ypx1Hqyu6r) => {
	return `🐦[*MENU ${Fanhcore__Bot}*]🐦
...
✅ Follow akun instagram admin ${fanhcore__2542}
...
♻️ Mau pasang iklan di *${Fanhcore__2542} ?*
☎️ WA : *${http://api.whatsapp.com/send?phone=6282132209625}*
  
⚠️ Gunakan dengan bijak ‼️
⚠️ Bot ini berjalan ${ketika diaktifkan oleh Owner} ‼️

✅Official Grub [1] : ${https://chat.whatsapp.com/GnLdLnx9zx69Ypx1Hqyu6r}



  
🐦[*POWERED BY ${Fanhcore__Bot}*]🐦`
}
